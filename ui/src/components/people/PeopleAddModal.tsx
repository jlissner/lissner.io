...
export function PeopleAddModal({ onAdd, onClose }: PeopleAddModalProps) {
  ...
  return (
    <div className="modal" onClick={onClose} role="presentation">
      <div className="modal__content" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="add-person-title">
        <h3 id="add-person-title" className="modal__title">Add person</h3>
        ...
        <div className="modal__actions">
          ...
          <button type="button" className="btn btn--primary" onClick={handleSubmit} disabled={!name.trim()}>
            Add
          </button>
        </div>
      </div>
